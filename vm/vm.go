...
func (vm *VM) Run() error {
	...
	for vm.currentFrame().ip < len(vm.currentFrame().Instructions())-1 {
		...
		case code.OpReturnValue:
			...
			vm.popFrame()           // pop the frame we just executed off the frame stack so that the next iteration of the VM’s main loop continues
			vm.pop()                // another vm.pop() call to get the just-called *object.CompiledFunction off the stack
